...
<head>
	<title>IX. Uluslararası Katılımlı Lizozomal Hastalıklar Kongresi | Kayıt & Konaklama</title>
                ...
                <center>
                    <div class="col-md-8" style="float: none;">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tr>
                                <td>Sponsorluğu Olmayan Firma Temsilcisi</td>
                                <td>₺ 25.000,00</td>
                                <td>₺ 45.000,00</td>
                            </tr>
                            <tr>
                ...
                <center>
                    <div class="col-md-6" style="float: none">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            <thead>
                            <tr>
                                <th colspan="2">Transfer Bedeli</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td>Çift Yön Toplu Transfer</td>
                                <td>€ 200,00</td>
                            </tr>
                            </tbody>
                        </table>
                ...
                <center>
                    <div class="col-md-6" style="float: none;">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tr>
                                <td><b>HESAP ADI</b></td>
                                <td>SOLO KONGRE ORGANİZASYON REKLAM VE ETKİNLİK YÖNETİMİ TİC. LTD. ŞTİ.</td>
                            </tr>
                            <tr>
                                <td><b>BANKA ADI</b></td>
                            ...
                            <tr>
                                <td><b>TL IBAN NO</b></td>
                                <td>TR41 0006 2000 4010 0006 2932 78</td>
                            </tr>
                            <tr>
                                <td><b>EUR IBAN NO</b></td>
                                <td>TR28 0006 2000 4010 0009 0614 07</td>
                            </tr>
                            <tr>
                                <td><b>SWIFT KODU</b></td>
                                <td>TGBATRIS</td>
                            </tr>
                            </tbody>
                        </table>
