...
$(document).ready(function() {
    ...
    function makeTimerEng() {
        ...
        if (minutes < "10") { minutes = "0" + minutes; }
        if (seconds < "10") { seconds = "0" + seconds; }
        $("#days-en").html(days + "<span>Days</span>");
        $("#hours-en").html(hours + "<span>Hours</span>");
        $("#minutes-en").html(minutes + "<span>Minutes</span>");
        $("#seconds-en").html(seconds + "<span>Seconds</span>");
    }
    setInterval(function() { makeTimerEng(); }, 0);
