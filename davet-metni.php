...
<!--			<div class="pic">-->
<!--				<img alt="" class="img-responsive img-circle" src="doc/haluk-hoca2.jpg" style="max-width: 120px;-->
<!--                                        border: 2px solid;-->
<!--                                        height: auto;-->
<!--                                        margin: 0 auto;-->
<!--                                        border-radius: 20%;-->
...
<!--		<div class="our-team" style="padding-bottom: 30px;">-->
<!--			<div class="pic">-->
<!--				<img alt="" class="img-responsive img-circle" src="doc/metin-aydogan.jpg" style="max-width: 120px;-->
<!--                                        border: 2px solid;-->
<!--                                        height: auto;-->
<!--                                        margin: 0 auto;-->
<!--                                        border-radius: 20%;-->
